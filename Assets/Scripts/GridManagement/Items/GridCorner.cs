...
public class GridCorner
{
    ...
    public GridCorner(GridVertex center, GridVertex left, GridVertex right)
    {
        ...
        _bottomLeft = left;
        _bottomRight = right;
        _topCenter = new GridVertex(center.x, center.y, center.z + GlobalConst.LAYER_HEIGHT);
        _topLeft = new GridVertex(left.x, left.y, left.z + GlobalConst.LAYER_HEIGHT);
        _topRight = new GridVertex(right.x, right.y, right.z + GlobalConst.LAYER_HEIGHT);
    }
}
