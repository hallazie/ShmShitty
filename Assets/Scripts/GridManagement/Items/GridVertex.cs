...

{
    ...
    private GridVertex _upperAdjecentVertex = null;
    private GridVertex _lowerAdjecentVertex = null;
    ...
    public GridVertex upperAdjecentVertex
    {
        get
        {
    ...
    public GridVertex lowerAdjecentVertex
    {
        get
        {
